...
insurrection_arrests$charges_clean = str_replace_all(insurrection_arrests$charges, '\n\n','; ')
insurrection_arrests$charges_clean = str_replace_all(insurrection_arrests$charges_clean, '\n','; ')


#write_csv(insurrection_arrests,"insur_arrests.csv")
